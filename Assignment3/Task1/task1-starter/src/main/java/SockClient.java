...
class SockClient {
    ...
    public static void main (String args[]) {
        ...
        try {
            ...
            while (requesting) {
                System.out.println("What would you like to do: 1 - echo, 2 - add, 3 - string concatenation, 4 - currency converter (0 to quit)");
                ...
                switch(choice) {
                    ...
                    case 4:
                        ...
                        System.out.println("Choose currency converter, enter amount:");
                        ...
                        json.put("type", "currencyconverter");
                ...
                if (res.getBoolean("ok")){
                    if (res.getString("type").equals("echo")) {
                        ...
                        System.out.println("Combined string: " + res.getString("combined"));
                    } else if (res.getString("type").equals("currencyconverter")) {
                        System.out.println("Converted amount: " + res.getDouble("converted"));
                    }
                } else {
